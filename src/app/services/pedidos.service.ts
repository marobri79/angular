...
export class PedidosService {
  ...
  enviarPedido(id: number): Observable<PedidoDTO> {
    
    return this.http.put<PedidoDTO>(`${environment.API_ENDPOINT}/api/pedidos/${id}/enviar`, null)
      .pipe(
        tap(pedido => console.log(`pedido con id ${id} enviado correctamente`)),
        catchError(this.handleError)
      );
  }
